						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header>
									...
									<h2>List of Doctors you can consult </h2>
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="80%">
											<thead>			                
												<tr>
													...
													<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i>Doctor Name</th>
													<th>Specialist In</th>
													<th data-hide="phone,tablet">Location</th>
													<th data-hide="phone,tablet"> Consult</th>
													<th>Review</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													...
													<td><a href="javascript:void(0);" class="btn btn-success btn-circle"><i class="fa fa-paper-plane"></i></a></td>
													<td>3</td>
