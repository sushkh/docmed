						...
						<div class="well no-padding">
							...
							<form action="{{URL::route('signup_patient')}}" method="post" id="smart-form-register" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" required name="password_confirmation" placeholder="Confirm Password" id="password_confirmation">
										</label>
									</section>
									...
									<div class="row">
										<section class="col col-6">
											...
											<section class="col col-6">
												<label class="input"> <i class="icon-append fa fa-question"></i>
													<input type="text" required name="bloodgroup" placeholder="bloodgroup">
												</label>
											</section>
										</div>
										...
										<section>
											<label class="input"> <i class="icon-append fa fa-phone"></i>
												<input type="tel" name="mobile" required id = "mobile" maxlength = "10" placeholder="Mobile" aria-required="true" aria-invalid="false" class="valid">
											</label>
										</section>
										...
										<section>
											...
											<label class="checkbox">
												...
												<i></i>I agree with the <a href = "{{URL::asset('#')}}" data-toggle="modal" data-target="#myModal"> Terms and Conditions </a></label>
											</section>
										</fieldset>
										<footer>
