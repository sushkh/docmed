		...
		<div id="content">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Edit Vendor details </h1>
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body no-padding">
				...
				<form id="login-form" class="smart-form" method="post" action = "{{URL::route('editvendor',$d->id)}}">
